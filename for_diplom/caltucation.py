...
# ]
# sin(), cos(), tan()
matrix_A = [[sin(array_radians_1[i + 1]) * tan(h) - sin(array_radians_1[i]) * tan(h), cos(array_radians_1[i + 1]) * tan(h) - cos(array_radians_1[i]) * tan(h)] for i in range(len(array_radians_1) - 1)]
matrix_A.append([sin(array_radians_1[-1]) * tan(h) - sin(array_radians_1[0]) * tan(h), cos(array_radians_1[-1]) * tan(h) - cos(array_radians_1[0]) * tan(h)])
print("Матрица А:")
