...
# add_thing(self, thing) - добавление нового предмета в рюкзак (добавление возможно, если суммарный вес (max_weight) не будет превышен, 
...
class Bag:
    ...
    def is_valid(self, thing):
        return sum(thing.weight for thing in self.__things) + thing.weight <= self.max_weight
