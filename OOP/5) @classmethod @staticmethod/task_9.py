...
class YouTube:
    ...
    def play(cls, video_indx):
        cls.videos[video_indx].play() # из коллекции videos класса YouTube находим нужный объект класса Video и вызываем метод класса Video play()
        # for_play = cls.videos[video_indx]
        # Video.play(for_play)
