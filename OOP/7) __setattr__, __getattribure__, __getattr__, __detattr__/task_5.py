...
class Module:
    ...
    def add_lesson(self, lesson: LessonItem):
        self.is_valid_type(lesson)
        self.lessons.append(lesson)

    @staticmethod
    def is_valid_type(lesson):
        if not isinstance(lesson, LessonItem):
            raise TypeError("Неверно передан тип данных.\nДолжен быть объект класса LessonItem!")
...
class Course:
    ...
    def add_module(self, module: Module):
        if not isinstance(module, Module):
            raise TypeError("Неверно передан тип данных.\nДолжен быть объект класса Module!")
